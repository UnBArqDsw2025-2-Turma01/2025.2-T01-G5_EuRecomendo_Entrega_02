...
*[Imagem do diagrama será adicionada em: ./assets/diagrama-atividades-avaliacao.png]*
...
|--------|-------|-----------|-----------|-------------|
|  `1.0` | 20/09 | Documentação inicial do Diagrama de Atividades | [Jose Eduardo Prado](https://github.com/jevprado), [Bruno Bragança](https://github.com/BrunoBReis), [Euller Júlio](https://github.com/Potatoyz908) e  [Tiago Balieiro](https://github.com/TiagoBalieiro) | ----- |
|  `1.1` | 20/09 | Adição do diagrama de avaliação e estruturação para outros fluxos | [Euller Júlio](https://github.com/Potatoyz908) | ----- |